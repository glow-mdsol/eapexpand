...
def main():
    ...
    parser.add_argument("--prisma", help="Generate Prisma Schema", action="store_true", default=False)
    parser.add_argument("--linkml", help="Generate LinkML Schema", action="store_true", default=False)
    parser.add_argument("--shapes", help="Generate SHACL Schema", action="store_true", default=False)
    opts = parser.parse_args()
    gen = dict(prisma=opts.prisma, 
               linkml=opts.linkml, 
               shapes=opts.shapes)
    source = opts.source
